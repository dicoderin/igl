...
S = '\033[1;33m'
os.system('clear')
print(f'''{G} ___ ____ _        _____           _ 
{G}|_ _/ ___| |      |_   _|__   ___ | |
{G} | | |  _| |   _____| |/ _ \ / _ \| |
{G} | | |_| | |__|_____| | (_) | (_) | |
{G}|___\____|_____|    |_|\___/ \___/|_|
   {B}B L A C K  {G}C O D E R  {E}C R U SH 
{G} GITHUB      : {B}@dicoderin
{G} TELEGRAM    : {B}@stewartid
{G} TG CHANNEL¹ : {B}@netbinsidofc
{G} TG CHANNEL² : {B}@ngeshare_bcc
{E}====================================''')
